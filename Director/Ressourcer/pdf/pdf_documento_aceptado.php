...
function obtener_d($nombre,$carrera,$semestre,$documentos,$fecha_envio,$fecha_respuesta,$ano,$director,$estatus){
...
$formato='<body>
  ...
  <div class="fecha">
      ...
      Asunto:Prórroga de entrega de <br>'.$documentos.'</p>
  </div>
...
<br>
<div class="contexto">
    La Dirección de la División de Ciencias del Capues Irapuato-Salamanca, en base al calendario Académico '.$ano.',<b> a '.$estatus.' la entrega de '.$documentos.'</b>
